export declare const STORAGE_METADATA = "aom.koa:storage";
export declare const STORAGE_SET_METADATA = "aom.koa:storage_set";
export declare const STORAGE_KEYS_SET_METADATA = "aom.koa:storage_keys_set";
...
export declare const MIDDLEWARES_LIST_METADATA = "aom.koa:middlewares_list";
...
export declare const REVERSE_METADATA = "aom.koa:reverse_link";
export declare const ERROR_METADATA = "aom.koa:error_result";
