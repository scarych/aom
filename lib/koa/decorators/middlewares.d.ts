import { CombinedDecorator, HandlerFunction, MarkerHandler, MiddlewareHandler } from "../../common/declares";
...
export declare function UseNext(handler: HandlerFunction): MethodDecorator;
